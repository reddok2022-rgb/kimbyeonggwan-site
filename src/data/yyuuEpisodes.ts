...
import ep22Raw from "../poems/yyuu/22.txt?raw";
import ep23Raw from "../poems/yyuu/23.txt?raw";
  ...
  
{
    ...
    title: "휴가 부재",
    status: "published",
    stanzas: parsePoem(ep17Raw),
  },

{
    id: 18,
    slug: "18",
    title: "표정은 처음부터 떠나갈 준비를 했다",
    status: "published",
    stanzas: parsePoem(ep18Raw),
  },
